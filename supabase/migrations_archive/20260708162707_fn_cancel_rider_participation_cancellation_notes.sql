-- Cancelling a rider's participation previously overwrote lesson_riders.rider_notes with the
-- cancellation reason, clobbering whatever notes already existed there. Write to the new
-- dedicated cancellation_notes column instead; rider_notes is now left untouched.

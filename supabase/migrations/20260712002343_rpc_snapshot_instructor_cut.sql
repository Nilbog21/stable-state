...
BEGIN
  ...
  VALUES (p_barn_id, p_instructor_id, p_lesson_at, p_fee, p_lesson_type, p_jumping, p_tier_name, p_payment_type, p_instructor_cut)
...
BEGIN
  ...
  VALUES (p_barn_id, p_instructor_id, p_fee, p_lesson_type, p_jumping, p_tier_name, p_horse_ids, p_exertion_levels, p_rider_ids, p_instructor_cut)
  ...
  VALUES (p_barn_id, p_instructor_id, p_lesson_at, p_fee, p_lesson_type, p_jumping, p_tier_name, p_payment_type, v_series.id, p_instructor_cut)
  RETURNING * INTO v_lesson;
...
BEGIN
  ...
  SET lesson_at = p_lesson_at, instructor_id = p_instructor_id, fee = p_fee, lesson_type = p_lesson_type,
      jumping = p_jumping, payment_type = p_payment_type, tier_name = p_tier_name, instructor_cut = p_instructor_cut

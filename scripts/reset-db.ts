...
// #1038: real JPEGs supplied manually into scripts/data/ (gitignored, not generated by
// any script) since dev-photo seeding needs realistic images, not a 1x1 placeholder.
...
async function run() {
  ...
  await replaceProfilePhoto(riderProfileIds[1], DEV_BARN_ID, emeryPhotoFile, 'jpg', supabase)
  ...
  await replaceHorsePhoto(horseIds[1], DEV_BARN_ID, butterPhotoFile, 'jpg', supabase)

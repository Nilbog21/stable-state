...
describe('DocumentUploadForm', () => {
  ...
  it('should_render_server_error_inline', () => {
    ...
    render(<DocumentUploadForm entity="horse" action={noop} />)
  ...
  it('should_show_instructor_contract_option_for_trainer_entity', () => {
    render(<DocumentUploadForm entity="trainer" action={noop} />)
  ...
  it('should_show_liability_waiver_option_for_rider_entity', () => {
    render(<DocumentUploadForm entity="rider" action={noop} />)

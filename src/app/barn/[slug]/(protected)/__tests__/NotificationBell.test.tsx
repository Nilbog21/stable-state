...
describe('NotificationBell', () => {
  ...
  it('should_render_bell_button', () => {
    render(<NotificationBell notifications={[]} barnSlug="barn-1" />)
  ...
  it('should_show_unread_count_badge_when_unread_notifications_exist', () => {
    render(<NotificationBell notifications={[unreadNotif]} barnSlug="barn-1" />)

    expect(screen.getByText('1')).toBeDefined()
  })

  it('should_hide_badge_when_all_notifications_are_read', () => {
    render(<NotificationBell notifications={[readNotif]} barnSlug="barn-1" />)
  ...
  it('should_close_dropdown_on_outside_click', () => {
    render(
      <div>
        ...
        <NotificationBell notifications={[unreadNotif]} barnSlug="barn-1" />
      </div>
    )
    fireEvent.click(screen.getByRole('button', { name: /notifications/i }))
  ...
  it('should_render_notification_as_link_when_link_present', () => {
    render(<NotificationBell notifications={[linkedNotif]} barnSlug="barn-1" />)
    fireEvent.click(screen.getByRole('button', { name: /notifications/i }))
  ...
  it('should_not_render_link_for_notification_without_link_field', () => {
    render(<NotificationBell notifications={[unlinkNotif]} barnSlug="barn-1" />)
    fireEvent.click(screen.getByRole('button', { name: /notifications/i }))

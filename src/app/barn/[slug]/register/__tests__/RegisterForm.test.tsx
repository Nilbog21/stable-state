...
describe('RegisterForm', () => {
  ...
  it('should_render_first_name_input_with_default_value', () => {
    render(<RegisterForm defaultFirstName="Jane" defaultLastName="Doe" action={mockAction as any} />)
  ...
  it('should_display_error_message_when_state_has_error', () => {
    ...
    render(<RegisterForm defaultFirstName="" defaultLastName="Doe" action={mockAction as any} />)

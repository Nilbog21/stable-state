...
// sit beneath it as `- **vN.0.x — …**` bullets under `### Later updates`. Both shapes are here so
...
- **Something shipped.** A feature bullet, not a patch lead-in.
...
describe('parseLatestVersion', () => {
  ...
  // The bullet marker went on in testing #1589; a lead-in hand-written as a bare paragraph is the
  // shape that predates it, and reads as correct to anyone editing the file by eye.
  it('should_tolerate_a_lead_in_written_without_its_bullet_marker', () => {
    const markdown =
      '# Changelog\n\n## v3.0.0 — July 2026\n\n### Later updates\n\n**v3.0.4 — July 2026.** Details.\n'

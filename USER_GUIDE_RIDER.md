...
If your barn manager has made you the owning member of any horse, a **My Horses** section appears at the top of the page listing those horses instead — each card shows a status badge (**Active**/**Unavailable**/**Inactive**), plus the unavailability reason when the badge is Unavailable, and the horse is no longer duplicated in its usual Available/Unavailable section.

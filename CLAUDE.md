...
- Before writing or debugging a spec, read `e2e/CLAUDE.md` — ten measured `@playwright/test`/Chromium/React 19 facts (timeout tiers, silent-auth request contexts, hydration races, viewport pins) that each cost the #1187–#1252 batch at least one round, several of them twice

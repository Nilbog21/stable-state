...
// permanent and the accuracy rule binds either way (docs/scripts/suite.md). Before #1281 only
...
// A `/**` glob is a literal string PREFIX (docs/scripts/suite.md), and the components these tests

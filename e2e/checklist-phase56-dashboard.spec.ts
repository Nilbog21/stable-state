...
// checklists/pre-release/phase-5-trainer.md's appointment-card, empty-state and
// own-lessons-only Dashboard lines, and phase-6-rider.md's Dashboard counterparts.
//

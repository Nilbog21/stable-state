...
- [ ] (e2e: a_checked_horses_bar_caption_names_the_band_and_total_it_would_land_in) (#1552) Each bar is captioned above with the band and total the horse *would* land in — `Moderate · 12 points` — so checking a horse moves its caption along with its ghost segment

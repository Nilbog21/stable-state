...
- [ ] (e2e: each_available_horse_card_captions_its_bar_with_that_horses_band_and_total) (#1552) Each bar is captioned above with its band and total — `Moderate · 8 points` — naming the same band the fill is painted

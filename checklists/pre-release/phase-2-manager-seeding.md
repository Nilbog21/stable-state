...
- [ ] (e2e: promoting_a_granted_rider_to_owner_elevates_their_document_and_lesson_access) (#1069) Dana's row now shows the **Lesson Schedule** switch turned on without tapping it directly (auto-elevated on becoming owner)

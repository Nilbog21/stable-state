...
- [ ] Horse detail page: a horse's photo (if a manager has set one) displays, but there is **no Add Photo / Replace Photo / Remove control**
...
- [ ] On a horse's detail page, a photo (if a manager has set one) displays, but there is **no Add Photo / Replace Photo / Remove control**

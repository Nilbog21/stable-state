...
- [ ] Rider Emery's member detail page shows an **Active Agreements** header with a one-line card for their boarding agreement (kind, horse, fee) linking to the agreement detail page; give Emery a second active agreement (e.g. a lease) and confirm a second card appears; a rider with no active agreements shows **No active agreements** with no add-boarding link; a managed (unclaimed) rider's detail page shows the same section

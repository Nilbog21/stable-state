...
- [ ] (e2e: a_manager_can_replace_a_photo_another_manager_set) Replace Apple's photo with `scripts/data/emery-photo.jpg` as manager → still succeeds (manager-set photos never lock out other managers)
